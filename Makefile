...
SRC = ft_bzero.c ft_strlen.c ft_strcpy.c ft_strncpy.c ft_strcmp.c\
	...
	ft_strstr.c ft_strnstr.c ft_strcat.c ft_strncat.c\
...
OBJS = ft_bzero.o ft_strlen.o ft_strcpy.o ft_strncpy.o ft_strcmp.o\
	...
	ft_isprint.o ft_isalpha.o ft_isalnum.o ft_toupper.o ft_tolower.o\
	ft_strstr.o ft_strnstr.o ft_strcat.o ft_strncat.o\
	ft_strlcat.o ft_memset.o ft_memcpy.o ft_memccpy.o ft_memcmp.o\
	ft_memmove.o ft_memchr.o ft_strchr.o ft_strrchr.o ft_putchar.o\
	ft_putchar_fd.o ft_putstr.o ft_putstr_fd.o ft_putnbr.o ft_putnbr_fd.o\
	ft_putendl.o ft_putendl_fd.o ft_strclr.o ft_memdel.o ft_strdel.o\
	ft_strnew.o ft_memalloc.o ft_strtrim.o ft_strequ.o ft_strnequ.o\
